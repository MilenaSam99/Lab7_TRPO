...
public class Positive {
    ...
    public Object[] UserData() {
        ...
        res[0] = new Account("Anna", "Karenina",Math.random() + "@mail.ru", "123456789",
    ...
    public void mainTest(Account user) {
        ...
        nameLabel = (new WebDriverWait(driver, 5)).until(presenceOfElementLocated(By.cssSelector("a.account > span")));
